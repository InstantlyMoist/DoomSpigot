...
import static mochadoom.doom.SourceCode.AM_Map.AM_Stop;
...
public interface IAutoMap<T,V> {
    ...
    // Color ranges for mochadoom.automap. Actual colors are bit-depth dependent.
    ...
    // Called by main loop,
    // called instead of view drawer if mochadoom.automap active.
    public void  Drawer ();
    
    // Added to be informed of gamma changes - Good Sign 2017/04/05
    public void Repalette();

    // Called to force the mochadoom.automap to quit
