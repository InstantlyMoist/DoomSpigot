...
//        doomFrame.dispose();
    ...
    /**
     * FULLSCREEN SWITCH CODE TODO: it'mochadoom.s not enough to do this without also switching the screen'mochadoom.s resolution.
     * Unfortunately, Java only has a handful of options which depend on the OS, driver, display, JVM etc. and it'mochadoom.s not
