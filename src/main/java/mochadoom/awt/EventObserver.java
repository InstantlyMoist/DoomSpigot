...
import static mochadoom.awt.EventBase.*;
 ...
 * to someone who needs them (DOOM'mochadoom.s internal event handling system)
 * 
...
public class EventObserver<Handler extends Enum<Handler> & EventBase<Handler>> {
    ...
    /**
     * Will be used to find Handler by AWTEvent'mochadoom.s id
     */
