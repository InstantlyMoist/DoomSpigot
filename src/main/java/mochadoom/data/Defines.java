...
//import mochadoom.m.define;

import mochadoom.defines.ammotype_t;
import mochadoom.defines.card_t;
import mochadoom.doom.weapontype_t;
import mochadoom.g.Signals;

import static mochadoom.data.Limits.MAXINT;
import static mochadoom.data.Limits.MININT;
import static mochadoom.m.fixed_t.*;

// Emacs style mode select   -*- C++ -*- 
//-----------------------------------------------------------------------------
//
// $Id: Defines.java,mochadoom.v 1.48 2012/09/24 17:16:22 velktron Exp $
//
...
//
// DESCRIPTION:
//  Internally used mochadoom.data structures for virtually everything,
...
//
// Global parameters/mochadoom.defines.
//
// DOOM version
...
// MAES: moved static mochadoom.defines out of here and into VideoScaleInfo.
...
static final String
rcsid = "$Id: Defines.java,mochadoom.v 1.48 2012/09/24 17:16:22 velktron Exp $";
}
