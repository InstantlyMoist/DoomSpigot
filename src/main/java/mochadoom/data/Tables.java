...
//-----------------------------------------------------------------------------
//
// $Id: Tables.java,mochadoom.v 1.22 2011/05/06 09:21:59 velktron Exp $
//
...
public final class Tables {
  ...
  /** Mod long angle_t'mochadoom.s with this value to cut off rollover */
 ...
 * e.mochadoom.g. ANG270 is supposed to be larger not only than ANG180, but also from
 ...
 * rollover compensation (e.mochadoom.g. result=(a+b+c) is wrong, result=(a+b+c)%0xFFFFFFFF
 ...
 * 4K of finesine'mochadoom.s values AFTER the 4K index. This removes the need
 ...
 *    
 *  The code has been thoroughly checked in both Sun'mochadoom.s JDK and GCC and was
 ...
 *  engineering and also found to be 100% faithful to the original mochadoom.data.
 * 
 * 
 */
...
public static void InitTables(){
    ...
    for (mochadoom.i=0 ; mochadoom.i<SLOPERANGE+1 ; mochadoom.i++)
    {
    
    a=(float)((mochadoom.i<<DBITS)/65536.0);
    t=(int)((float)(2*Math.atan(a)/PI)*0x40000000); 
    tantoangle[mochadoom.i] = t;
    } 
    */
