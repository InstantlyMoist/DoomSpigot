...
//-----------------------------------------------------------------------------
//
// $Id: doomdata.java,mochadoom.v 1.4 2011/02/11 00:11:13 velktron Exp $
//
...
//
// DESCRIPTION:
//  all external mochadoom.data is defined here
//  most of the mochadoom.data is loaded into different structures at run time
...
// Some global mochadoom.defines, that configure the game.


public class doomdata{
//
// Map level types.
// The following mochadoom.data structures define the persistent format
...
class mapnode_t
{
  ...
  // else it'mochadoom.s a node of another subtree.
