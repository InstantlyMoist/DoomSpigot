 ...
 *  too much crap and redundant mochadoom.data. In order to keep mochadoom.demo
...
public class VanillaTiccmd implements CacheableDoomObject, IDemoTicCmd,IWritableDoomObject{
     ...
     *  in reading ticcmd_t'mochadoom.s from a lump is when playing back demos.
    ...
    public void encode(ticcmd_t source) {
        ...
        // OUCH!!! NASTY PRECISION REDUCTION... but it'mochadoom.s the
