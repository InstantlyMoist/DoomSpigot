...
import mochadoom.utils.ResourceIO;
...
public class CVarManager {
    ...
    /**
     * Checks that CVar of any type is passed as Command Line Argument with proper value(mochadoom.s)
     * @param cv
     * @return boolean
     */
     ...
     * 
     * mochadoom.i.e. (String mochadoom.s) -> System.out.println(mochadoom.s) will try to get string,
