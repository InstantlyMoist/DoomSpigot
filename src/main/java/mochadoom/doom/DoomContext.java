 ...
 *  implementations (e.mochadoom.g. rendering code), and only specialize methods/classes when
 ...
 *  Indexed and HiColor e.mochadoom.g. new MyClass.Indexed() and new MyClass.HiColor(), while any common
