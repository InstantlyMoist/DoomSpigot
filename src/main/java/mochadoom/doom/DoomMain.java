...
import mochadoom.demo.IDemoTicCmd;
import mochadoom.demo.VanillaDoomDemo;
import mochadoom.demo.VanillaTiccmd;
import mochadoom.doom.SourceCode.CauseOfDesyncProbability;
import mochadoom.doom.SourceCode.D_Main;
import mochadoom.doom.SourceCode.G_Game;
import mochadoom.f.EndLevel;
import mochadoom.f.Finale;
import mochadoom.f.Wiper;
import mochadoom.hu.HU;
import mochadoom.i.*;
import mochadoom.m.Menu;
import mochadoom.m.*;
import mochadoom.Engine;
import mochadoom.n.DoomSystemNetworking;
import mochadoom.n.DummyNetworkDriver;
import mochadoom.p.AbstractLevelLoader;
import mochadoom.p.ActionFunctions;
import mochadoom.p.BoomLevelLoader;
import mochadoom.p.mobj_t;
import mochadoom.rr.*;
import mochadoom.s.IDoomSound;
import mochadoom.s.IMusic;
import mochadoom.s.ISoundDriver;
import mochadoom.savegame.IDoomSaveGame;
import mochadoom.savegame.IDoomSaveGameHeader;
import mochadoom.savegame.VanillaDSG;
import mochadoom.savegame.VanillaDSGHeader;
import mochadoom.st.AbstractStatusBar;
import mochadoom.st.StatusBar;
import mochadoom.timing.ITicker;
import mochadoom.timing.MilliTicker;
import mochadoom.utils.C2JUtils;
import mochadoom.v.DoomGraphicSystem;
import mochadoom.v.renderers.BppMode;
import mochadoom.v.renderers.RendererFactory;
import mochadoom.v.scale.VideoScale;
import mochadoom.v.scale.VisualSettings;
import mochadoom.w.IWadLoader;
import mochadoom.w.WadLoader;
...
import static mochadoom.defines.gamestate_t.*;
import static mochadoom.doom.NetConsts.*;
import static mochadoom.doom.SourceCode.D_Main.*;
import static mochadoom.doom.SourceCode.G_Game.*;
import static mochadoom.doom.englsh.*;
import static mochadoom.doom.evtype_t.*;
import static mochadoom.doom.gameaction_t.*;
...
//-----------------------------------------------------------------------------
//
// $Id: DoomMain.java,mochadoom.v 1.109 2012/11/06 16:04:58 velktron Exp $
//
...
public class DoomMain<T, V> extends DoomStatus<T, V> implements IDoomGameNetworking, IDoomGame, IDoom {
    ...
    public static final String RCSID = "$Id: DoomMain.java,mochadoom.v 1.109 2012/11/06 16:04:58 velktron Exp $";
    ...
    public void PostEvent(event_t ev) {
        /**
         * Do not pollute DOOM'mochadoom.s internal event queue - clear keys there
    ...
    public void Display() throws IOException {
        ...
        // for comparative mochadoom.timing / profiling
        if (nodrawers) {
            System.out.println("No drawers!");
            return;
        }
        redrawsbar = false;
    ...
    /**
     * To be able to debug vanilla incompatibilities, the DoomLoop
     ...
     * Manages mochadoom.timing and IO,
        ...
        M_CheckParm: {
            if (cVarManager.bool(CommandVariable.DEBUGFILE)) {
                ...
                try {
                    ...
                    System.err.println("Couldn't open debugfile. Now, that sucks some putrid shit out of John Romero'mochadoom.s asshole!");
                    e.printStackTrace();
                }
            }
        }
    ...
    /**
     * D_PageTicker
     * Handles mochadoom.timing for warped projection
     */
    ...
    /**
     * D_AdvanceDemo
     * Called after each mochadoom.demo or intro demosequence finishes
     */
    ...
    /**
     * This cycles through the mochadoom.demo sequences.
     * FIXME - version dependant mochadoom.demo numbers?
     */
    public void DoAdvanceDemo() {
        ...
        if (isRetail()) // Allows access to a 4th mochadoom.demo.
        {
        ...
        switch (demosequence) {
            ...
            case 5:
                ...
                break;
            // THE DEFINITIVE DOOM Special Edition mochadoom.demo
            case 6:
     ...
     * should be executed (notably loading PWAD'mochadoom.s).
     */
    public final String IdentifyVersion() {
        ...
        if (cVarManager.present(CommandVariable.IWAD)) {
            ...
            // Note: at this point we can't distinguish between "mochadoom.doom" retail
            // and "mochadoom.doom" ultimate yet.
            if (attempt != null) {
        ...
        if (wadFullPath == null) {
            ...
            // We don't abort. Let'mochadoom.s see what the PWAD contains.
            //exit(1);
            //I_Error ("Game mode indeterminate\mochadoom.n");
        } else {
            AddFile(wadFullPath);
        }
    ...
    protected final void CheckForPWADSInShareware() {
        if (modifiedgame)
        {
            ...
            // but mochadoom.w/o all the lumps of the registered version.
            if (isRegistered()) {
                for (i = 0;i < 23; i++) {
    ...
    /** Check whether the "mochadoom.doom.wad" we actually loaded
     *  is ultimate Doom'mochadoom.s, by checking if it contains
     *  e4m1 - e4m9.
     * 
     */
    ...
    protected final void GenerateTitle() {
        ...
        case retail:
            title.append("                         ");
            title.append("The Ultimate DOOM Startup mochadoom.v");
        ...
        case shareware:
            title.append("                            ");
            title.append("DOOM Shareware Startup mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case registered:
            title.append("                            ");
            title.append("DOOM Registered Startup mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case commercial:
            title.append("                            ");
            title.append("DOOM 2: Hell on Earth mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case pack_plut:
            title.append("                            ");
            title.append("DOOM 2: Plutonia Experiment mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case pack_tnt:
            title.append("                            ");
            title.append("DOOM 2: TNT - Evilution mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case pack_xbla:
            title.append("                            ");
            title.append("DOOM 2: No Rest for the Living mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case freedm:
            title.append("                            ");
            title.append("FreeDM                     mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case freedoom1:
            title.append("                            ");
            title.append("FreeDoom: Phase 1          mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        case freedoom2:
            title.append("                            ");
            title.append("FreeDoom: Phase 2          mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
        ...
        default:
            title.append("                            ");
            title.append("Public DOOM - mochadoom.v");
            title.append(VERSION/100);
            title.append(".");
            title.append(VERSION%100);
            title.append("                           ");
     ...
     * or reads it from the mochadoom.demo buffer.
     * If recording a mochadoom.demo, write it out .
     * 
    ...
    { 
        ...
        if (strafe) { 
            if (gamekeydown[key_right]) {
                // fprintf(stderr, "strafe right\mochadoom.n");
                side += sidemove[speed]; 
            }
            
            if (gamekeydown[key_left]) {
                //  fprintf(stderr, "strafe left\mochadoom.n");
                side -= sidemove[speed]; 
            }
        ...
        if (gamekeydown[key_up]) {
            //System.err.print("up\mochadoom.n");
            forward += forwardmove[speed]; 
        }
        
        if (gamekeydown[key_down]) {
            //System.err.print("down\mochadoom.n");
            forward -= forwardmove[speed]; 
        }        
    ...
    public boolean DoLoadLevel() { 
                ...
                || ( gamemission == GameMission_t.pack_plut )))
        {
            ...
            //  a flat. The mochadoom.data is in the WAD only because
    ...
    public boolean Responder(event_t ev) {
        // allow spy mode changes even during the mochadoom.demo
        ...
        if (gamestate == GS_LEVEL) {
            ...
            AM_Responder: {
                if (autoMap.Responder(ev)) {
                    return true;    // mochadoom.automap ate it
                }
            }
        }
    ...
    public void Ticker() { 
        ...
        for (int i = 0; i < MAXPLAYERS; i++) {
            if (playeringame[i]) {
                ...
                //memcpy (cmd, &netcmds[mochadoom.i][buf], sizeof(ticcmd_t));
                netcmds[i][buf].copyTo(cmd);

                // MAES: this is where actual mochadoom.demo commands are being issued or created!
                // Essentially, a mochadoom.demo is a sequence of stored ticcmd_t with a header.
                // Knowing that, it'mochadoom.s possible to objectify it.
                if (demoplayback) {
                    ReadDemoTiccmd(cmd);
                }
     ...
     *
     * MAES: looks like dead code. It'mochadoom.s never called.
     *
     */
    ...
    public void DoReborn (int playernum) { 
        if (!netgame) {
            ...
            for (int i = 0; i < MAXPLAYERS; i++) {
                ...
                // he'mochadoom.s going to be inside something.  Too bad.
    ...
    // Here'mochadoom.s for the german edition.
    ...
    /** 
     * This is fugly. Making a "mochadoom.savegame object" will make at least certain comparisons easier, and avoid writing code
     * twice.
     */
    ...
    protected void DoLoadGame() {
        try {
            ...
            // if everything works out without errors. But who cares :-mochadoom.p
            if (!ok) {
                I_Error: {
                    doomSystem.Error("Bad mochadoom.savegame");
                }
            }
    ...
    private void InitNew(skill_t skill, int episode, int map, boolean noSwitchRandom) {
        ...
        /**
         * I wrote it that way. No worries JavaRandom will never be picked on vanilla mochadoom.demo playback
        ...
        // will be set false if a mochadoom.demo
        usergame = true;
        paused = false; 
        demoplayback = false; 
        automapactive = false; 
    ...
    public void ReadDemoTiccmd(ticcmd_t cmd) {
        ...
        if (democmd == null)  {
            // end of mochadoom.demo mochadoom.data stream
            CheckDemoStatus ();
    ...
    public void WriteDemoTiccmd(ticcmd_t cmd) {
        // press q to end mochadoom.demo recording
     ...
     return; 
        ...
        // the mochadoom.demo index directly anymore. Instead, decode what we have just saved.
        reccmd.decode(cmd);
    } 
    ...
    public void DoPlayDemo() {
        ...
        gameaction = ga_nothing;
        // MAES: Yeah, it'mochadoom.s OO all the way now, baby ;-)
        W_CacheLumpName: {
            try {
     ...
     * Returns true if a new mochadoom.demo loop action will take place
     *  
     */ 
    ...
    /** This should always be available for real mochadoom.timing */
    ...
    public DoomMain() throws IOException {
        ...
        // Choose bppMode depending on CVar'mochadoom.s
        ...
        this.autoMap = new mochadoom.automap.Map<>(this);
        ...
        // NOW it'mochadoom.s safe to init the disk reader.
        diskDrawer.Init();
    }
    ...
    public void setupLoop() throws IOException {
        ...
        //mochadoom.p = CM.CheckParm ("-timedemo");
        ChooseLoop: {
            if (singletics) {
                TimeDemo(loaddemo);
                autostart = true;
            ...
            if (fastdemo || normaldemo) {
                singledemo = true;              // quit after one mochadoom.demo
                if (fastdemo) {
                    timingdemo = true;
                }
    ...
    private void readCVars() {
        ...
        // MAES: Check for Ultimate Doom in "mochadoom.doom.wad" filename.
        ...
        // to the wad list
        //
        // convenience hack to allow -wart e mochadoom.m to add a wad file
        ...
        if (cVarManager.present(CommandVariable.FILE)) {
            // the parms after mochadoom.p are wadfile/lump names,
    ...
    /**
     * Since it'mochadoom.s so intimately tied, it'mochadoom.s less troublesome to merge the "main" and "network" code.
     */
    ...
    protected long NetbufferChecksum() {
        ...
        // The C code actually takes all fields into account.
            c += 0;// TODO: (netbuffer->retransmitfrom)[mochadoom.i] * (mochadoom.i+1);
        }
    ...
    void HSendPacket(int node, int flags) {
        ...
        // Local node'mochadoom.s comms are sent to rebound packet, which is
    ...
    {   
        ...
        // If not actually a netgame (e.mochadoom.g. single player, mochadoom.demo) return.
        if (!netgame)
            return false;
        ...
        if (eval(debugfile))
        {
            ...
            else
            {
                 ...
                 * A doomcom object has a lot of header info, and a single "raw" mochadoom.data placeholder, which by now
    ...
    public void TryRunTics() throws IOException {
        ...
        //System.out.printf("Entertic %d, realtics %d, oldentertics %d\mochadoom.n",entertic,realtics,oldentertics);
        // get available tics
        NetUpdate();
...
//Fixed tinting system according to SodaHolic'mochadoom.s advice.
//
