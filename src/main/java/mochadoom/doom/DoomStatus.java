...
import mochadoom.data.mapthing_t;
import mochadoom.defines.*;
import mochadoom.demo.IDoomDemo;
import mochadoom.f.Finale;
...
/**
 * We need globally shared mochadoom.data structures, for defining the global state
...
public abstract class DoomStatus<T,V> {
 ...
 // MAES: declared as "extern", shared with Menu.java
    ...
    // (e.mochadoom.g. no sound volume adjustment with menu.
    ...
    // mochadoom.w/o a reference LUT in a sound module.
    ...
    // No mochadoom.demo, there is a human player in charge?
    ...
    // Quit after playing a mochadoom.demo from cmdline.
    ...
    /* A "fastdemo" is a mochadoom.demo with a clock that tics as
    ...
    // TODO: Netgame stuff (buffers and pointers, mochadoom.i.e. indices).
   ...
   // USELESS protected int demoend;
    ...
    /** This is an alias for mousearray [1+mochadoom.i] */
...
// $Log: DoomStatus.java,mochadoom.v $
...
// Merged finnw'mochadoom.s changes for enabling polling of ?_LOCK keys.
//
