...
/** Meant to provide a more lightweight alternative to Java'mochadoom.s serialization model,
 ...
 *  overhead. Since it'mochadoom.s for send-only purposes, it won't matter if it'mochadoom.s  modified.
 *   *  
...
public interface IDatagramSerializable {
         ...
         *  on each object'mochadoom.s implementation. Will NOT also copy
         *  the byte[] caches. 
         */
         ...
         *  from a specified offset, dependant on each object'mochadoom.s
         *  implementation.
         */
        public void unpack(byte[] buf, int offset);
        
        /** Only use this if you are 100% sure that the object'mochadoom.s content
