...
public class doomdata_t implements IDatagramSerializable {
	...
	public static final int DOOMDATALEN = 8 + mochadoom.data.Defines.BACKUPTICS * ticcmd_t.TICCMDLEN;
	...
	public doomdata_t() {
		cmds = malloc(ticcmd_t::new, ticcmd_t[]::new, mochadoom.data.Defines.BACKUPTICS);
    ...
    public byte[] pack() {        
        ...
        // FIXME: it'mochadoom.s probably more efficient to use System.arraycopy ?
        // Or are the packets too small anyway? At most we'll be sending "doomdata_t'mochadoom.s"
