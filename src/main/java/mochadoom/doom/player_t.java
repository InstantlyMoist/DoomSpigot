...
import mochadoom.data.state_t;
import mochadoom.defines.*;
import mochadoom.doom.SourceCode.P_Pspr;
import mochadoom.p.ActiveStates.PlayerSpriteConsumer;
import mochadoom.p.mobj_t;
import mochadoom.p.pspdef_t;
...
import static mochadoom.data.info.*;
import static mochadoom.doom.SourceCode.G_Game.*;
import static mochadoom.doom.SourceCode.P_Pspr.*;
import static mochadoom.doom.items.weaponinfo;
import static mochadoom.m.fixed_t.*;
import static mochadoom.p.mobj_t.*;
import static mochadoom.utils.C2JUtils.*;
import static mochadoom.utils.GenericCopy.malloc;

/**
 * Extended player object info: player_t The player mochadoom.data structure depends on a
 ...
 * the player mochadoom.data struct, as commands per game tick.
 *
 * #include "d_ticcmd.h"
 */
public class player_t /*extends mobj_t */ implements Cloneable, IReadableDoomObject, IPackableDoomObject {
     ...
     * CORRECTION: this is also used by the mochadoom.automap widget.
     * MAES: fugly hax, as even passing "Integers" won't work, as they are immutable.
     * Fuck that, I'mochadoom.m doing it the fugly MPI Java way!
     */
     ...
     * my ass. It'mochadoom.s yet another pointer alias into colormaps. Ergo, array and
     * pointer.
     */
    ...
    /**
     * It'mochadoom.s probably faster to clone the null player
     */
    public void reset() {
    ...
    @SourceCode.G_Game.C(G_PlayerFinishLevel)
...
//
    ...
    public int identify() {
        ...
        int i;
        // Let'mochadoom.s assume that we know jack.
     ...
     *
     */
    @SourceCode.G_Game.C(G_PlayerReborn)
    public void PlayerReborn() {
        ...
        // We save the player'mochadoom.s frags here...
        ...
        // a new object.memset (mochadoom.p, 0, sizeof(*mochadoom.p));
    ...
    public void read(DataInputStream f) throws IOException {
        ...
        // TODO: OK, so vanilla'mochadoom.s monsters lost "state" when saved, including non-Doomguy
        ...
        // at least one (e.mochadoom.g. object #45 is pointer 0x43545345) then, since
    ...
    public void write(DataOutputStream f) throws IOException {
        ...
        // It'mochadoom.s much more convenient to pre-buffer, since
