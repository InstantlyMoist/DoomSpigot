...
import mochadoom.p.ThinkerStates;
...
import static mochadoom.utils.C2JUtils.pointer;
...
public class thinker_t implements CacheableDoomObject, IReadableDoomObject, IPackableDoomObject {
    ...
    public void pack(ByteBuffer b)
        throws IOException {
        // It'mochadoom.s possible to reconstruct even by hashcodes.
        ...
        //System.out.printf("Packed thinker %d %d %d\mochadoom.n",pointer(prev),pointer(next),pointer(function));
    }
    ...
    public void unpack(ByteBuffer b)
        ...
        nextid = b.getInt();
        functionid = b.getInt();
        //System.out.printf("Unpacked thinker %d %d %d\mochadoom.n",pointer(previd),pointer(nextid),pointer(functionid));
    }
