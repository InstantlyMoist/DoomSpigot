...
import mochadoom.w.animenum_t;

import static mochadoom.data.Defines.TICRATE;
...
public abstract class AbstractEndLevel {
	...
	// MAES: cute, but we can do it in a more Java-friendly way :-mochadoom.p

    public static final int[] NUMANIMS = {epsd0animinfo.length, epsd1animinfo.length, epsd2animinfo.length};

	/** ATTENTION: there'mochadoom.s a difference between these "anims" and those used in p_spec.c */
