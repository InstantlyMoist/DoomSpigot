 ...
 *  Fucked-up  because it'mochadoom.s supposed to wrap fixed_t'mochadoom.s.... no fucking way I'mochadoom.m doing
...
public class BBox {
	...
	/**
	 * MAES: Keeping with C'mochadoom.s type (in)consistency, we also allow to input ints
	 * -_-
	 * 
	 * @param x
	 * @param y
