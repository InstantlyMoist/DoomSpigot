...
import static mochadoom.doom.SourceCode.M_Random.*;
 ...
 * whenever you start recording or playing mochadoom.demo. When you start then new game, MochaDoom restores new JavaRandom.
 * 
 * However, if you start MochaDoom with -javarandom command line argument and -record mochadoom.demo,
 * then MochaDoom will record the mochadoom.demo using JavaRandom. Such mochadoom.demo will be neither compatible
