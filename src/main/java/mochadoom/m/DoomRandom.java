...
//-----------------------------------------------------------------------------
//
// $Id: DoomRandom.java,mochadoom.v 1.4 2013/06/04 11:29:25 velktron Exp $
//
...
//
// $Log: DoomRandom.java,mochadoom.v $
...
// Added mochadoom.demo sync tooling.
//
...
class DoomRandom implements IRandom{
    ...
    public int P_Random(ActiveStates caller, int sequence) {
        int value = P_Random();
        /*
	SLY.sync("PR #%d %s_%d [%d]=%d\mochadoom.n", caller.ordinal(),caller,sequence,
			prndindex, value);*/
        return value;
    }
