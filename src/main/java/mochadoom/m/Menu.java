...
import mochadoom.doom.SourceCode.M_Menu;
import mochadoom.g.Signals.ScanCode;
import mochadoom.rr.patch_t;
import mochadoom.timing.DelegateTicker;
...
import static mochadoom.data.dstrings.*;
import static mochadoom.doom.SourceCode.M_Menu.*;
...
public class Menu<T, V> extends AbstractDoomMenu<T, V> {
    ...
    /** we are going to be entering a mochadoom.savegame string */
    ...
    /**
     * M_ReadSaveStrings
     * read the strings from the mochadoom.savegame files
     */
    ...
    /**
     * Draw border for the mochadoom.savegame description. This is special in that it'mochadoom.s
     ...
     * 
     * Actually it just counts occurences of 'mochadoom.n' and adds height to height.
     */
    ...
    class M_ChangeDetail implements MenuRoutine {
        ...
        public void invoke(int choice) {
            ...
            //System.err.print("M_ChangeDetail: low detail mode mochadoom.n.a.\mochadoom.n");
