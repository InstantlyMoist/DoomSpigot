...
//-----------------------------------------------------------------------------
//
// $Id: MenuMisc.java,mochadoom.v 1.29 2012/09/24 17:16:22 velktron Exp $
//
...
public abstract class MenuMisc{
    ...
    public static final String rcsid = "$Id: MenuMisc.java,mochadoom.v 1.29 2012/09/24 17:16:22 velktron Exp $";
   ...
   byte[]     palette )
 {
     ...
     pcx = new pcx_t();
     pack=new byte[width*height*2]; // allocate that much mochadoom.data, just in case.
...
// It'mochadoom.s never fun having to come up with your own function for string manipulation!
//
