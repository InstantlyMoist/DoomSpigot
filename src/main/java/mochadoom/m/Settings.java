...
import mochadoom.awt.FullscreenOptions;
import mochadoom.doom.ConfigBase.Files;
import mochadoom.doom.ConfigManager;
import mochadoom.Engine;
import mochadoom.utils.QuoteType;
import mochadoom.v.graphics.Plotter;
import mochadoom.v.renderers.BppMode;
import mochadoom.v.renderers.SceneRendererMode;
import mochadoom.v.tables.GreyscaleFilter;

import java.util.*;

import static mochadoom.doom.ConfigBase.FILE_DOOM;
import static mochadoom.doom.ConfigBase.FILE_MOCHADOOM;
...
public enum Settings {
    ...
    vestrobe(FILE_MOCHADOOM, false), // Strobe effect on mochadoom.automap cut off from vanilla
    ...
    reconstruct_savegame_pointers(FILE_MOCHADOOM, true); // In vanilla, infighting targets are not restored on mochadoom.savegame load
