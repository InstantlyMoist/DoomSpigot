...
// -----------------------------------------------------------------------------
//
// $Id: cheatseq_t.java,mochadoom.v 1.8 2011/11/01 23:47:50 velktron Exp $
//
...
//
// $Log: cheatseq_t.java,mochadoom.v $
...
public class cheatseq_t {
    ...
    // This holds the actual mochadoom.data (was a char*).
     ...
     * cheat was successful, false if failed. MAES: Let'mochadoom.s make this boolean.
     * 
     * @param cht
     * @param key
     * @return
    ...
    public boolean CheckCheat(int key) {
        ...
        if (sequence[p] == 0)
            ...
            // *(cht->mochadoom.p++) = key;
            sequence[p++] = (char) key;
            //mochadoom.p++;  //_D_: this fixed cheat with parm problem (IDCLIP)
