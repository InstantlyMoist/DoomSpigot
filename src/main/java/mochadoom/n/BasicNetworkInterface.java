...
import mochadoom.doom.doomcom_t;
import mochadoom.doom.doomdata_t;
import mochadoom.w.DoomBuffer;

import java.io.IOException;
import java.net.*;

import static mochadoom.data.Limits.MAXNETNODES;
import static mochadoom.doom.NetConsts.*;

// Emacs style mode select   -*- C++ -*- 
//-----------------------------------------------------------------------------
//
// $Id: BasicNetworkInterface.java,mochadoom.v 1.5 2011/05/26 13:39:06 velktron Exp $
//
...
//
// $Log: BasicNetworkInterface.java,mochadoom.v $
...
public class BasicNetworkInterface implements DoomSystemNetworking {
    ...
    // NETWORKING
    //
    // Maes: come on, we all know it'mochadoom.s 666.
    ...
    // We also reuse always the same DatagramPacket, "peged" to sw'mochadoom.s byte buffer.
    ...
    public class PacketSend implements NetFunction {
        ...
        public void invoke() {
          ...
          for (mochadoom.doom.ticcmd_t t: sendData.cmds)
              System.out.print(t.consistancy+",");
          System.out.println();*/
            // The socket already contains the address it needs,
            // and the packet'mochadoom.s buffer is already modified. Send away.
    ...
    public class PacketGet implements NetFunction {
        ...
        public void invoke() {
          ...
          for (mochadoom.doom.ticcmd_t t: recvData.cmds)
              System.out.print(t.consistancy+",");
          System.out.println();*/
            {
                //static int first=1;
