...
import mochadoom.doom.SourceCode.P_Map;
import mochadoom.doom.SourceCode.P_MapUtl;
...
import mochadoom.rr.subsector_t;
...
import mochadoom.utils.TraitFactory.ContextKey;
import mochadoom.utils.TraitFactory.Trait;

import java.util.function.Predicate;

import static mochadoom.data.Limits.MAXRADIUS;
import static mochadoom.data.Limits.MAXSPECIALCROSS;
import static mochadoom.doom.SourceCode.P_Map.PIT_CheckLine;
import static mochadoom.doom.SourceCode.P_Map.P_CheckPosition;
import static mochadoom.doom.SourceCode.P_MapUtl.P_BlockLinesIterator;
import static mochadoom.doom.SourceCode.P_MapUtl.P_BlockThingsIterator;
import static mochadoom.m.BBox.*;
import static mochadoom.p.AbstractLevelLoader.FIX_BLOCKMAP_512;
import static mochadoom.p.mobj_t.MF_MISSILE;
import static mochadoom.p.mobj_t.MF_NOCLIP;
import static mochadoom.rr.line_t.ML_BLOCKING;
import static mochadoom.rr.line_t.ML_BLOCKMONSTERS;
