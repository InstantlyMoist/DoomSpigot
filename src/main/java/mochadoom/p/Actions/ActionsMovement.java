...
import static mochadoom.data.Defines.FLOATSPEED;
import static mochadoom.data.Defines.PT_ADDLINES;
import static mochadoom.data.Limits.MAXMOVE;
import static mochadoom.data.Tables.*;
import static mochadoom.doom.SourceCode.P_Map.PTR_SlideTraverse;
import static mochadoom.m.fixed_t.FRACUNIT;
import static mochadoom.m.fixed_t.FixedMul;
import static mochadoom.p.ChaseDirections.*;
