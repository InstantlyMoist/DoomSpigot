...
import static mochadoom.data.Limits.MAXINTERCEPTS;
import static mochadoom.doom.SourceCode.P_MapUtl.P_PathTraverse;
import static mochadoom.m.fixed_t.*;
import static mochadoom.p.MapUtils.InterceptVector;
