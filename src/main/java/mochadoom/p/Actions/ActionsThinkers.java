...
import mochadoom.p.*;
import mochadoom.p.ActiveStates.MobjConsumer;
import mochadoom.p.ActiveStates.ThinkerConsumer;
...
import static mochadoom.doom.SourceCode.P_Spec.P_SpawnSpecials;
import static mochadoom.doom.SourceCode.P_Tick.P_RemoveThinker;
import static mochadoom.m.fixed_t.FRACBITS;
import static mochadoom.p.DoorDefines.FASTDARK;
import static mochadoom.p.DoorDefines.SLOWDARK;
import static mochadoom.p.mobj_t.MF_SPAWNCEILING;
