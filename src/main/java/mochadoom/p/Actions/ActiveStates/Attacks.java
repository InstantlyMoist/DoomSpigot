 ...
 */
package mochadoom.p.Actions.ActiveStates;
...
import mochadoom.p.Actions.ActionsSectors.Spawn;
...
import static mochadoom.doom.player_t.ps_flash;
import static mochadoom.m.fixed_t.FRACUNIT;
import static mochadoom.p.Actions.ActionsSectors.KEY_SPAWN;
import static mochadoom.p.mobj_t.MF_JUSTATTACKED;
