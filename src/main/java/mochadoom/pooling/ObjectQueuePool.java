package mochadoom.pooling;

import mochadoom.p.mobj_t;

import java.util.Stack;

/** A convenient object mochadoom.pooling class, derived from the stock ObjectPool.
 *  
 *  It'mochadoom.s about 50% faster than calling new, and MUCH faster than ObjectPool
