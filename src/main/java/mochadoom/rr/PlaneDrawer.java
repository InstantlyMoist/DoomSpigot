...
import mochadoom.rr.RendererState.IPlaneDrawer;
...
public abstract class PlaneDrawer<T,V> implements IPlaneDrawer {
    ...
    /** The visplane mochadoom.data. Set separately. For threads, use the same for
     *  everyone.
     */
     ...
     * 
     * Uses global vars: planeheight ds_source -> flat mochadoom.data has already been
