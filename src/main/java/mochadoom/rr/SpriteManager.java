...
import static mochadoom.utils.C2JUtils.memset;
...
public class SpriteManager<T, V> implements ISpriteManager {
        ...
        protected final void InitSpriteDefs(String[] namelist) {
            ...
            for (i = numentries - 1; i >= 0; i--) {
                ...
                // Create chain list for each sprite class (e.mochadoom.g. TROO, POSS,
                // etc.)
                //
            ...
            for (i = 0; i < numsprites; i++) {
                ...
                if (list != null && !list.isEmpty()) {
                    ...
                    // relative
                    // to e.mochadoom.g. TROO. In coalesced lumps, there will be overlap.
        ...
        protected final void InstallSpriteLump(int lump, int frame,
            ...
            if (rotation == 0) {
                 ...
                 // happens because rotate'mochadoom.s value could be -1 at this point (!),
                 // if a series of circumstances occur. Therefore it'mochadoom.s actually a
                ...
                if (sprtemp[frame].rotate == 1) {
                     ...
                     // MAES: This can only happen if we decided that a sprite'mochadoom.s
    ...
    /*  public void InitSpriteDefs2(String[] namelist) {
            ...
            for (int mochadoom.i = 0; mochadoom.i < numsprites; mochadoom.i++) {
                // System.out.println("Preparing sprite "+mochadoom.i);
                spritename = namelist[mochadoom.i];
                ...
                maxframe = -1;
                intname = name8.getIntName(namelist[mochadoom.i].toUpperCase());
                ...
                for (int l = start + 1; l < end; l++) {
                    ...
                    if (cname.length == 6 || cname.length == 8) // Sprite names
                        ...
                        // frames
                        // for a particular sprite e.mochadoom.g. TROOAx, TROOHxHy etc.
                        //
                ...
                if (maxframe == -1) {
                    ...
                    getSprites()[mochadoom.i].numframes = 0;
                ...
                sprites[mochadoom.i].copy(sprtemp, maxframe);

                // sprites[mochadoom.i].numframes = maxframe;
                // sprites[mochadoom.i].spriteframes = new spriteframe_t[maxframe];
                // C2JUtils.initArrayOfObjects(sprites[mochadoom.i].spriteframes,spriteframe_t.class);

                // for (int j=0;j<)
                // System.arraycopy(src, srcPos, dest, destPos, length)
                // memcpy (sprites[mochadoom.i].spriteframes, sprtemp,
