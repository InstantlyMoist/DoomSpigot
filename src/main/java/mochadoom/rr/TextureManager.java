...
import mochadoom.rr.parallel.IGetSmpColumn;
 ...
 *  by an implementing class. As of now, the renderer does both, though it'mochadoom.s
...
public interface TextureManager<T> extends IGetColumn<T>, IGetCachedColumn<T>,IGetSmpColumn{
    ...
    /** Return a "sanitized" patch. If mochadoom.data is insufficient, return
