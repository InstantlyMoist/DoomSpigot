...
import static mochadoom.data.Defines.FF_FRAMEMASK;
import static mochadoom.data.Defines.FF_FULLBRIGHT;
import static mochadoom.data.Limits.MAXVISSPRITES;
import static mochadoom.data.Tables.ANG45;
import static mochadoom.data.Tables.BITS32;
import static mochadoom.m.fixed_t.*;
import static mochadoom.p.mobj_t.MF_SHADOW;
import static mochadoom.rr.SceneRenderer.MINZ;
...
public final class VisSprites<V>
     ...
     * mochadoom.data. It'mochadoom.s a bit of dumb thing to do, since the overflow sprite is never
     * rendered but we have to copy mochadoom.data over it anyway. Would make more sense
     * to check for it specifically and avoiding copying mochadoom.data, which should be
    ...
    public final void SortVisSprites() {
        ...
        // Maes: got rid of old vissprite sorting code. Java'mochadoom.s is better
