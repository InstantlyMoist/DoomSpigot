...
/** Actual visplane mochadoom.data and methods are isolate here.
 *  This allows more encapsulation and some neat hacks like sharing 
 *  visplane mochadoom.data among parallel renderers, without duplicating them.
 */
...
public class Visplanes {
     ...
     * e.mochadoom.g. due to sprites, windows etc.
     */
    ...
    public int CheckPlane(int index, int start, int stop) {
        ...
        // If start is smaller than the plane'mochadoom.s min...
        //
    ...
    */
    ...
    protected final int FindPlane2(int height, int picnum, int lightlevel) {
        ...
        // but we can't link directly to it, we need to copy its mochadoom.data
        // around.
