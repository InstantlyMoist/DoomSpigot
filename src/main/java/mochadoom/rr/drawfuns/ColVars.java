 ...
 *  drawing when it'mochadoom.s more convenient, and since they are non-overlapping we can
...
public class ColVars<T,V> {    
     ...
     * primitives since it'mochadoom.s performance-critical in the renderer.
