...
import static mochadoom.m.fixed_t.FRACBITS;
     ...
     /**
	 * Adapted from Killough'mochadoom.s Boom code. There are optimized as well as
...
public final class R_DrawColumn extends DoomColumnFunction<byte[],short[]> {
    ...
    public void invoke() {
        ...
        // e.mochadoom.g. a DDA-lile scaling.
        ...
        do {
             ...
             * A: it'mochadoom.s pointing inside screen[0] (set long before we came here)
             * dc_source is a pointer to a decompressed column'mochadoom.s mochadoom.data.
             * Oh Woe if it points at non-pixel mochadoom.data.
             */
