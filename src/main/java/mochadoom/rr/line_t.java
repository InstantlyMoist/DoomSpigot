...
import mochadoom.p.Interceptable;
...
import static mochadoom.doom.SourceCode.P_Spec.getNextSector;
...
public class line_t
    ...
    /** Don't draw on the mochadoom.automap at all. */
    public static final int ML_DONTDRAW = 128;

    /** Set if already seen, thus drawn in mochadoom.automap. */
