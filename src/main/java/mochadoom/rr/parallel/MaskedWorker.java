...
public abstract class MaskedWorker<T,V> extends AbstractThings<T,V> implements Runnable, IDetailAware{
    ...
    protected final void DrawPSprite(pspdef_t psp) {
        ...
        //System.out.printf("Weapon draw from %d to %d\mochadoom.n",vis.x1,vis.x2);
        DrawVisSprite(vis);
    }
    ...
    public void run() {
        ...
        // Update thread'mochadoom.s own vissprites
        
        final vissprite_t<V>[] vissprites=VIS.getVisSprites();
        final int numvissprites=VIS.getNumVisSprites();
        
        //System.out.printf("Sprites to render: %d\mochadoom.n",numvissprites);
        ...
        //System.out.printf("Segs to render: %d\mochadoom.n",ds_p);
