 ...
 * column-based. It does function, but is broken and has unsolved mochadoom.data dependencies.
 * It'mochadoom.s therefore not used in official releases, and I chose to deprecate it.
...
public abstract class ParallelRenderer2<T, V> extends AbstractParallelRenderer<T, V> {
	...
	{   
		// Viewing variables are set according to the player'mochadoom.s mobj. Interesting hacks like
  ...
  if (Math.random()>0.999){
	  ...
	  player.mo=crap;
        ...
        // System.out.printf("Submitted %d RSIs\mochadoom.n",RSIcount);
...
//            visplanebarrier.await();
    ...
    public static final class Indexed extends ParallelRenderer2<byte[], byte[]> {
        ...
        protected void R_InitDrawingFunctions() {
            ...
            // or unused e.mochadoom.g. parallel renderers ignore them.
