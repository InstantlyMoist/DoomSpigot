...
/**
 * This is what actual executes the RenderWallInstruction. Essentially it'mochadoom.s a
    ...
    public void run() {
        ...
        for (int i = 0; i < rmiend; i++) {
            ...
            dc_flags=RMI[i].dc_flags;
                //System.err.printf("Flags transition %d\mochadoom.n",dc_flags);
                if (lowdetail){
            ...
            // No need to set shared DCvars, because it'mochadoom.s passed with the arg.
