...
import mochadoom.doom.SourceCode.P_Spec;
import mochadoom.doom.SourceCode.fixed_t;
import mochadoom.m.IRandom;
...
import static mochadoom.data.Limits.MAXINT;
import static mochadoom.data.Limits.MAX_ADJOINING_SECTORS;
import static mochadoom.doom.SourceCode.P_Spec.P_FindLowestCeilingSurrounding;
...
public class sector_t implements IReadableDoomObject, IPackableDoomObject, Resettable {
     ...
     * that'mochadoom.s really a futile distinction.
     */
    ...
    /** list of mobjs in sector (MAES: it'mochadoom.s used as a linked list) */
    ...
    public int FindHighestFloorSurrounding() {
        ...
        for (i = 0; i < this.linecount; i++) {
            ...
            // some older 1.6 JDKs, but that'mochadoom.s obviously not true.
            if (other == null)
                continue;
     ...
     * Note: this should be doable mochadoom.w/o a fixed array.
     * 
     * @param sec
     * @param currentheight
     * @return fixed
    ...
    public void read(DataInputStream f)
        ...
        // like to read memory-format sector_t'mochadoom.s is from
