...
/**
 * Now what is a visplane, anyway? Basically, it'mochadoom.s a bunch of arrays buffer representing a top and a bottom boundary of
...
public class visplane_t {
    ...
    // Not the cleanest system possible, but it'mochadoom.s backwards compatible
    ...
    /**
     * "Clear" the top with FF'mochadoom.s.
     */
    ...
    /**
     * "Clear" the bottom with FF'mochadoom.s.
     */
