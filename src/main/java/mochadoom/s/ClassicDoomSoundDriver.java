...
/**
 * A close recreation of the classic linux mochadoom.doom sound mixer.
 * 
 * PROS:
...
public class ClassicDoomSoundDriver extends AbstractSoundDriver
    ...
    /**
     * The channel mochadoom.data pointers, start and end. These were referred to as
     ...
     * i_sound.c they are actual mochadoom.data channels.
     */
    ...
    public void UpdateSound() {
        ...
        while (leftout < leftend) {
            ...
            for (chan = 0; chan < numChannels; chan++) {
                ...
                // if (D) System.err.printf("Checking channel %d\mochadoom.n",chan);
        ...
        // Q: what'mochadoom.s the purpose of channelremainder etc?
    ...
    public void ShutdownSound() {
        ...
        while (!done) {
            ...
            // System.err.printf("%d channels died off\mochadoom.n",mochadoom.i);
    ...
    public void SubmitSound() {
        ...
        // It'mochadoom.s possible for us to stay silent and give the audio
