...
/** Concern separated from David Martel'mochadoom.s MIDI & MUS player
...
//		        //  System.out.println(info[mochadoom.i].getName()+"\t\t\t"+ mdev.isOpen()+"\t"+mdev.hashCode());
//
//		     }
//
//		     //System.out.printf("x %d y %d \mochadoom.n",x,y);
...
//	        try {
//	            // If mochadoom.data is a midi file, load it directly
