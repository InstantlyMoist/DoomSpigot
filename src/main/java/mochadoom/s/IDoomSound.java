...
//-----------------------------------------------------------------------------
//
// $Id: IDoomSound.java,mochadoom.v 1.5 2011/08/24 15:55:12 velktron Exp $
//
...
// Anything high-level like e.mochadoom.g. handling of panning, sound origin,
// sound multiplicity etc. should be handled here, but not e.mochadoom.g. actual
// sound playback, sound threads, etc.
//  That'mochadoom.s the job of ISound and IMusic (roughly equivelnt to i_sound.*, but
...
public interface IDoomSound {
	...
	public static final int S_ATTENUATOR	=((S_CLIPPING_DIST-S_CLOSE_DIST)>> mochadoom.m.fixed_t.FRACBITS);
	...
	// not be part of the interface, even though it'mochadoom.s convenient to reuse them.
	//
