...
public interface Colors {
     ...
     *
     *  WARNING: there'mochadoom.s no sanity/overflow check for performance reasons.
     *
     * @param r
     * @param g
     * @param b
    ...
    /**
     * Finds a color in the palette'mochadoom.s range from rangel to rangeh closest to specified r, mochadoom.g, b
