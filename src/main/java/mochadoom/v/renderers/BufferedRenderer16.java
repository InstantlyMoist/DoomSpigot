...
import mochadoom.v.tables.ColorTint;
...
import static mochadoom.v.tables.ColorTint.GREY_TINTS;
import static mochadoom.v.tables.ColorTint.NORMAL_TINTS;
 ...
 * The separate LUT'mochadoom.s are generated for this renderer
 * 
...
class BufferedRenderer16 extends SoftwareParallelVideoRenderer<byte[], short[]> {
     ...
     *
     * NOTE: this relies on the ability to "tap" into a BufferedImage'mochadoom.s backing array, in order to have fast writes
...
//
// $Log: BufferedRenderer16.java,mochadoom.v $
