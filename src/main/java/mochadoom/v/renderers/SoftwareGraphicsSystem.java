...
import mochadoom.v.DoomGraphicSystem;
import mochadoom.v.graphics.*;
import mochadoom.v.scale.VideoScale;
import mochadoom.v.tables.GammaTables;
...
{   
    /**
     * Each screen is [SCREENWIDTH*SCREENHEIGHT]; This is what the various modules (menu, mochadoom.automap, renderer etc.) get to
     ...
     * (paintjob) to complex (multiple BufferedImages with locked mochadoom.data bits...) ugh!
     * 
