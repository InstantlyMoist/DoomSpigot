...
package mochadoom.v.tables;

import mochadoom.doom.DoomMain;
import mochadoom.doom.player_t;
import mochadoom.v.renderers.BppMode;

import static mochadoom.p.MobjFlags.MF_TRANSLATION;
import static mochadoom.p.MobjFlags.MF_TRANSSHIFT;
 ...
 * @author velktron
 *
 * @param <V> The mochadoom.data type of the SCREEN
 */
...
public class LightsAndColors<V> {
    ...
    private static class LCData {
        ...
        /**
         * These two are tied by an inverse relationship. E.mochadoom.g. 256 levels, 0 shift
        ...
        /** Number of diminishing brightness levels.
           There a 0-31, mochadoom.i.e. 32 LUT in the COLORMAP lump.
         ...
         *  it'mochadoom.s capped by the number of light levels???
         *  
         ...
         *  Normally it'mochadoom.s 12 for 32 levels, so 11 for 64, 10 for 128, ans 9 for 256.
         *  
         */
