 ...
 *  
 *  E.mochadoom.g. an object of type A consists of a header and a list of objects of type B.
 ...
 *  along.
 *  
 *  This system works cleanly, and allows to simulate Doom'mochadoom.s "cached memory" while
 *  returning proper objects of the correct type and keeping close to Java'mochadoom.s
 ...
 *  objects (e.mochadoom.g. in the caching mechanism) is not needed.
 *    
 * 
 * @author Velktron
 *
