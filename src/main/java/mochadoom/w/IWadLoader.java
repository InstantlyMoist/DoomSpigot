...
import mochadoom.v.graphics.Lights;
import mochadoom.v.tables.Playpal;

import java.io.IOException;
import java.nio.ByteBuffer;
import java.util.function.IntFunction;

import static mochadoom.doom.SourceCode.W_Wad.*;
import static mochadoom.v.graphics.Palettes.PAL_NUM_COLORS;
import static mochadoom.v.graphics.Palettes.PAL_NUM_STRIDES;
...
public interface IWadLoader {
     ...
     * It'mochadoom.s rare, but has its uses.
     *
     * @param name
     * @param tag
     * @param what
    ...
    /**
     * Specific method for loading cached patches by name, since it'mochadoom.s by FAR the
    ...
    /**
     * Specific method for loading cached patches, since it'mochadoom.s by FAR the most
     * common operation.
     *
     * @param name
     * @param tag
     ...
     * can/must be skipped, and if we want actual mochadoom.data we must
     * read the next one.
     *
     * @param lump
     * @return
     ...
     * for when you are e.mochadoom.g. repairing palette lumps or doing other sanity
     * checks.
     *
     * @param lump
     * @param obj
