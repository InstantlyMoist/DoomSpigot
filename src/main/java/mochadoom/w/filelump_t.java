...
public class filelump_t  implements IReadableDoomObject, IWritableDoomObject {
    ...
    public String actualname; // Sanitized name, e.mochadoom.g. after compression markers
        
    public boolean big_endian=false; // E.mochadoom.g. Jaguar
    ...
    public void read(DataInputStream f) throws IOException{
        ...
        // It'mochadoom.s a compressed lump
        if (stuff[0] > 0x7F) {
