...
public class wadfile_info_t {
      ...
      public ZipEntry entry; // Secondary resource identifier e.mochadoom.g. files inside zip archives.
      public int type; // as per InputStreamSugar
      public wad_source_t src;
      public InputStream handle;
      public boolean cached; // Whether we use local caching e.mochadoom.g. for URL or zips
